      ...
      {!stats ? (
        ...
        <>
          ...
          <div className="pt-2 text-center">
            <Link
              href="/otokogi/stats/playground"
              className="inline-block rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 text-sm text-amber-700 hover:bg-amber-100"
            >
              お遊び統計を見る →
            </Link>
          </div>
